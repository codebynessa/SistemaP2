 ...
 * @author vanes
 */
public class CadastroEntradaProduto extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CadastroEntradaProduto.class.getName());

    /**
     * Creates new form CadastroPagamento
     */
    public CadastroEntradaProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtIdFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
          EntradaProdutoDTO dto = new EntradaProdutoDTO(
                ...
                txtIdFornecedor.getText(),
                txtIdUsuario.getText()
        );

        EntradaProdutoController.salvar(dto);
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CadastroEntradaProduto dialog = new CadastroEntradaProduto(new javax.swing.JFrame(), true);
