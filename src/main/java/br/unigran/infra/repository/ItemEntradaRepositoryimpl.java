 ...
 * @author vanes
 */
public class ItemEntradaRepositoryimpl implements ItemEntradaRepository {

    JPAUtil dao = JPAUtil.getInstace();

    @Override
    public void salvar(Object itemEntrada) {
        dao.salvar(itemEntrada);
    }
    ...
    public Object findByID(Integer id) {
        return dao.findById(id, ItemEntrada.class);
    }
